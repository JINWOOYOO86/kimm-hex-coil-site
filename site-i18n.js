...
(function () {
  var EN = {
    ...
    'mob.c.map': 'Face/row distribution', 'mob.c.xls': 'Excel export', 'mob.c.home': 'Add to home screen',
    ...
    'spec.res.k': 'Results',
    'spec.res.v': 'Capacity Q · pressure drop ΔP · condensate · air and refrigerant inlet/outlet states · psychrometric chart · P–h diagram · face/row distribution colour maps',
    'spec.file.k': 'Files',
    'spec.file.v': 'Excel design template import and export · result export (geometry, circuit diagram, conditions, per-cell raw data)<br>Load a <b>result file</b> and the results are restored without recomputing',
